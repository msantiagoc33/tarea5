...
public class Fechas {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A�os entre dos fechas: "+dias);
        ...
        // aumentar la fecha actual 1 a�o y 2 meses
        System.out.println("La fecha dentro de 1 a�o y 3 meses es "+fechaActual.plusYears(1).plusMonths(2));
        
        // fecha 10 dias antes de hoy
        System.out.println("Fecha 10 dias antes de la fecha actual: "+fechaActual.minusDays(10));

        // representa el primer dia del presente a�o
        System.out.println("El primer dia del presente a�o era "+fechaActual.withDayOfYear(1));
